// src/ui/TransitionScreen.jsx
import React, { useEffect } from "react";
import { Card } from "./primitives";

export default function TransitionScreen({ title = "Got it.", subtitle, onDone, ms = 700 }) {
  useEffect(() => {
  ...
  return (
    <Card className="flex items-center justify-between gap-6">
      <div>
        ...
        {subtitle && <div className="mt-1 text-[14px] text-slate-600">{subtitle}</div>}
      </div>
